INSERT OR IGNORE INTO user (id, name, email, email_verified, created_at, updated_at, display_name, role, status) VALUES ('019ddfc0-c0cf-757b-a406-9768bc1bbdc5', 'Seed Author', 'seed@vibekit.local', 1, cast(unixepoch('subsecond') * 1000 as integer), cast(unixepoch('subsecond') * 1000 as integer), 'Seed Author', 'admin', 'active');
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019ddfc0-c0d0-708d-a59c-e93ea5a1ed88', 'SvelteKit', 'sveltekit', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019ddfc0-c0d0-708d-a59c-e93f8896f3e7', 'Cloudflare', 'cloudflare', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019ddfc0-c0d0-708d-a59c-e94031ae9781', 'Authentication', 'authentication', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019ddfc0-c0d0-708d-a59c-e9416714fb65', 'Drizzle ORM', 'drizzle-orm', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019ddfc0-c0d0-708d-a59c-e942f8e66cd1', 'Edge Computing', 'edge-computing', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_post (id, title, slug, excerpt, content_body, seo_title, seo_description, status, author_id, published_at, created_at, updated_at) VALUES ('019ddfc0-c0d0-708d-a59c-e94356dd9c65', 'Getting Started with SvelteKit 2', 'getting-started-with-sveltekit-2', 'A comprehensive guide to building modern web applications with SvelteKit 2, from project setup to deployment on Cloudflare Workers.', '## Why SvelteKit 2?
...
INSERT OR IGNORE INTO blog_post (id, title, slug, excerpt, content_body, seo_title, seo_description, status, author_id, published_at, created_at, updated_at) VALUES ('019ddfc0-c0d0-708d-a59c-e944ea3050c0', 'Building a SaaS Product on Cloudflare Workers', 'building-saas-on-cloudflare-workers', 'How to leverage Cloudflare''s edge platform to build fast, globally distributed SaaS applications with minimal infrastructure overhead.', '## The Edge Computing Advantage
...
INSERT OR IGNORE INTO blog_post (id, title, slug, excerpt, content_body, seo_title, seo_description, status, author_id, published_at, created_at, updated_at) VALUES ('019ddfc0-c0d0-708d-a59c-e945dfd343be', 'Authentication Best Practices for SvelteKit Apps', 'authentication-best-practices-sveltekit', 'A deep dive into implementing secure authentication in SvelteKit using Better Auth, with patterns for session management, route guards, and role-based access.', '## Why Better Auth?
...
INSERT OR IGNORE INTO blog_post (id, title, slug, excerpt, content_body, seo_title, seo_description, status, author_id, published_at, created_at, updated_at) VALUES ('019ddfc0-c0d0-708d-a59c-e94744d813b1', 'The Future of Edge Computing for Web Developers', 'future-of-edge-computing-web-developers', 'Exploring how edge computing is reshaping web development and what it means for building the next generation of applications.', '## What is Edge Computing?
...
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e94356dd9c65', '019ddfc0-c0d0-708d-a59c-e93ea5a1ed88');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e94356dd9c65', '019ddfc0-c0d0-708d-a59c-e93f8896f3e7');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e944ea3050c0', '019ddfc0-c0d0-708d-a59c-e93f8896f3e7');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e944ea3050c0', '019ddfc0-c0d0-708d-a59c-e942f8e66cd1');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e945dfd343be', '019ddfc0-c0d0-708d-a59c-e94031ae9781');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e945dfd343be', '019ddfc0-c0d0-708d-a59c-e93ea5a1ed88');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e946302b3e8b', '019ddfc0-c0d0-708d-a59c-e9416714fb65');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e946302b3e8b', '019ddfc0-c0d0-708d-a59c-e93f8896f3e7');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e94744d813b1', '019ddfc0-c0d0-708d-a59c-e942f8e66cd1');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019ddfc0-c0d0-708d-a59c-e94744d813b1', '019ddfc0-c0d0-708d-a59c-e93f8896f3e7');
