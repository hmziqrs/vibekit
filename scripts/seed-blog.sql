INSERT OR IGNORE INTO user (id, name, email, email_verified, created_at, updated_at, display_name, role, status) VALUES ('019db6ba-ec9a-76f6-9a4c-0b43a2235382', 'Seed Author', 'seed@vibekit.local', 1, cast(unixepoch('subsecond') * 1000 as integer), cast(unixepoch('subsecond') * 1000 as integer), 'Seed Author', 'admin', 'active');
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019db6ba-ec9b-7d83-b2df-d2d70df65eb4', 'SvelteKit', 'sveltekit', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019db6ba-ec9b-7d83-b2df-d2d853a219f3', 'Cloudflare', 'cloudflare', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019db6ba-ec9b-7d83-b2df-d2d9bdc537e0', 'Authentication', 'authentication', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019db6ba-ec9b-7d83-b2df-d2da045f20fe', 'Drizzle ORM', 'drizzle-orm', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_tag (id, name, slug, created_at) VALUES ('019db6ba-ec9b-7d83-b2df-d2dbff2b8b05', 'Edge Computing', 'edge-computing', cast(unixepoch('subsecond') * 1000 as integer));
INSERT OR IGNORE INTO blog_post (id, title, slug, excerpt, content_body, seo_title, seo_description, status, author_id, published_at, created_at, updated_at) VALUES ('019db6ba-ec9b-7d83-b2df-d2dc21abe670', 'Getting Started with SvelteKit 2', 'getting-started-with-sveltekit-2', 'A comprehensive guide to building modern web applications with SvelteKit 2, from project setup to deployment on Cloudflare Workers.', '## Why SvelteKit 2?
...
INSERT OR IGNORE INTO blog_post (id, title, slug, excerpt, content_body, seo_title, seo_description, status, author_id, published_at, created_at, updated_at) VALUES ('019db6ba-ec9b-7d83-b2df-d2dd907fa8bd', 'Building a SaaS Product on Cloudflare Workers', 'building-saas-on-cloudflare-workers', 'How to leverage Cloudflare''s edge platform to build fast, globally distributed SaaS applications with minimal infrastructure overhead.', '## The Edge Computing Advantage
...
INSERT OR IGNORE INTO blog_post (id, title, slug, excerpt, content_body, seo_title, seo_description, status, author_id, published_at, created_at, updated_at) VALUES ('019db6ba-ec9b-7d83-b2df-d2de310d515d', 'Authentication Best Practices for SvelteKit Apps', 'authentication-best-practices-sveltekit', 'A deep dive into implementing secure authentication in SvelteKit using Better Auth, with patterns for session management, route guards, and role-based access.', '## Why Better Auth?
...
INSERT OR IGNORE INTO blog_post (id, title, slug, excerpt, content_body, seo_title, seo_description, status, author_id, published_at, created_at, updated_at) VALUES ('019db6ba-ec9b-7d83-b2df-d2e0954f71a1', 'The Future of Edge Computing for Web Developers', 'future-of-edge-computing-web-developers', 'Exploring how edge computing is reshaping web development and what it means for building the next generation of applications.', '## What is Edge Computing?
...
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2dc21abe670', '019db6ba-ec9b-7d83-b2df-d2d70df65eb4');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2dc21abe670', '019db6ba-ec9b-7d83-b2df-d2d853a219f3');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2dd907fa8bd', '019db6ba-ec9b-7d83-b2df-d2d853a219f3');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2dd907fa8bd', '019db6ba-ec9b-7d83-b2df-d2dbff2b8b05');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2de310d515d', '019db6ba-ec9b-7d83-b2df-d2d9bdc537e0');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2de310d515d', '019db6ba-ec9b-7d83-b2df-d2d70df65eb4');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2df4066adab', '019db6ba-ec9b-7d83-b2df-d2da045f20fe');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2df4066adab', '019db6ba-ec9b-7d83-b2df-d2d853a219f3');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2e0954f71a1', '019db6ba-ec9b-7d83-b2df-d2dbff2b8b05');
INSERT OR IGNORE INTO blog_post_tag (post_id, tag_id) VALUES ('019db6ba-ec9b-7d83-b2df-d2e0954f71a1', '019db6ba-ec9b-7d83-b2df-d2d853a219f3');
