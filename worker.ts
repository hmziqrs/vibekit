...
import { base_path, manifest, prerendered } from './.svelte-kit/cloudflare-tmp/manifest.js'
...
const n = /* @__PURE__ */ new Set([200, 203, 204, 300, 301, 404, 405, 410, 414, 501])
function r(e3) {
  if (!n.has(e3.status)) {
    return false
  }
