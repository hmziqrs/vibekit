// @ts-nocheck — auto-generated by @sveltejs/adapter-cloudflare, only valid after build
// This file is AUTO-GENERATED by @sveltejs/adapter-cloudflare during build.
// To add a scheduled handler for cron triggers, run: bun run postbuild
// See: scripts/postbuild-add-cron.ts
...
var worker_default = {
  ...
  // Cron scheduled handler — dispatches to API endpoints
  async scheduled(event, env2, ctx) {
    const origin = env2.ORIGIN || `https://${env2.ASSETS ? 'vibekit' : 'localhost:8787'}`
